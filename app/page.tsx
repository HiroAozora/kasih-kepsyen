      ...
      <div className="w-full max-w-7xl glass-panel rounded-3xl p-6 md:p-8 relative z-10 min-h-[85vh] flex flex-col">
        ...
        >
          ...
          <div className="flex flex-col gap-6 h-full overflow-y-auto pr-2 custom-scrollbar">
            {/* RESULT VIEW */}
            <div
              className={`${state.success && state.data ? "block" : "hidden"} flex flex-col gap-4 h-full animate-in fade-in slide-in-from-bottom-4 duration-500`}
            >
            ...
            {/* FORM INPUTS View */}
            <div
              className={`${state.success && state.data ? "hidden" : "block"} flex flex-col gap-6`}
            >
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="Santai & Friendly">Santai & Friendly</option>
              ...
              <div className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10">
                <span className="text-sm text-gray-300">Sembunyikan Emoji</span>
